...
public class ApiEntityPlayerActionPack {
...
//
//    public ApiEntityPlayerActionPack(BaseEntity playerIn, ActionPackPlayer actionPackPlayer)
//    {
//        baseEntity = playerIn;
...
//    }
//
//    public ApiEntityPlayerActionPack start(ActionType type, Action action)
//    {
...
//    }
//
//    public ApiEntityPlayerActionPack setSneaking(boolean doSneak)
//    {
//        sneaking = doSneak;
...
//        return this;
//    }
//    public ApiEntityPlayerActionPack setSprinting(boolean doSprint)
//    {
//        sprinting = doSprint;
...
//    }
//
//    public ApiEntityPlayerActionPack setForward(float value)
//    {
//        forward = value;
//        return this;
//    }
//    public ApiEntityPlayerActionPack setStrafing(float value)
//    {
//        strafing = value;
//        return this;
//    }
//    public ApiEntityPlayerActionPack look(EnumDirection direction)
//    {
...
//        return this;
//    }
//    public ApiEntityPlayerActionPack look(WrapperVec2 rotation)
//    {
//        return look(rotation.x, rotation.y);
//    }
//
//    public ApiEntityPlayerActionPack look(float yaw, float pitch)
//    {
//        actionPackPlayer.look(yaw, pitch);
//        return this;
//    }
//
//    public ApiEntityPlayerActionPack lookAt(WrapperVec3 position)
//    {
//        actionPackPlayer.lookAt(position);
//        return this;
//    }
//
//    public ApiEntityPlayerActionPack turn(float yaw, float pitch)
//    {
//        return look(player.getEyeLocation().getYaw() + yaw,player.getEyeLocation().getPitch() + pitch);
//    }
//
//    public ApiEntityPlayerActionPack turn(WrapperVec2 rotation)
//    {
//        return turn(rotation.x, rotation.y);
//    }
//
//    public ApiEntityPlayerActionPack stopMovement()
//    {
//        setSneaking(false);
//        setSprinting(false);
//        forward = 0.0F;
...
//
//
//    public ApiEntityPlayerActionPack stopAll()
//    {
...
//    }
//
//    public ApiEntityPlayerActionPack mount(boolean onlyRideables)
//    {
//        //test what happens
...
//        return this;
//    }
//    public ApiEntityPlayerActionPack dismount()
//    {
...
//        }
//    }
//    static RayTraceResult getTarget(ApiEntityPlayerActionPack actionPack)
//    {
//        double reach = actionPack.player.getGameMode() == GameMode.CREATIVE ? 5 : 4.5f;
//
//        return ApiTracer.rayTrace(actionPack.player, reach, false);
//    }
//    static WrapperBlockHitResult getTargetBlock(ApiEntityPlayerActionPack actionPack)
//    {
//        double reach = actionPack.player.getGameMode() == GameMode.CREATIVE ? 5 : 4.5f;
//
//        return ApiTracer.rayTraceBlocks(actionPack.actionPackPlayer, reach, false, actionPack.player);
//    }
//
...
//                    {
//                        ApiEntityPlayerActionPack ap = player.getApiActionPack();
...
//            @Override
//            boolean execute(BaseEntity player, Action action) {
//                ApiEntityPlayerActionPack actionPack = player.getApiActionPack();
...
//                    void inactiveTick(BaseEntity player, Action action)
//                    {
//                        player.getApiActionPack().actionPackPlayer.setJumping(false);
//                    }
//                },
//        DROP_ITEM(true)
//                {
...
//        }
//
//        Boolean tick(ApiEntityPlayerActionPack actionPack, ActionType type)
//        {
//            next--;
//            Boolean cancel = null;
//            if (next <= 0)
...
//        }
//
//        void retry(ApiEntityPlayerActionPack actionPack, ActionType type)
//        {
