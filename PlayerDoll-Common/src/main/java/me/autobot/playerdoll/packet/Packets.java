...
import me.autobot.playerdoll.packet.factory.Packet_v1_20_R3;
import me.autobot.playerdoll.packet.factory.Packet_v1_20_R4;
import me.autobot.playerdoll.packet.factory.Packet_v1_21_R1;
...
public interface Packets {
    enum protocolNumber {
        ...
        public IPacketFactory getFactory(SocketReader reader) {
            return switch (this) {
                case v1_20_R3 -> new Packet_v1_20_R3(reader);
                case v1_20_R4 -> new Packet_v1_20_R4(reader);
                case v1_21_R1 -> new Packet_v1_21_R1(reader);
            };
        }
    }
