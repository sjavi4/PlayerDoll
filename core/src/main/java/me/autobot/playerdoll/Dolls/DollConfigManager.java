...
public class DollConfigManager {
    ...
    public static final HashMap<UUID,DollConfigManager> dollConfigManagerMap = new HashMap<>();
    ...
    public DollConfigManager(YamlConfiguration dollConfig, Player doll) {
        ...
        dollConfigManagerMap.put(doll.getUniqueId(), this);
    }
    ...
    public void removeListener(PropertyChangeListener l) {
        ...
        dollConfigManagerMap.put(this.player.getUniqueId(), null);
    ...
    public static DollConfigManager getConfigManager(Player player) {
        return dollConfigManagerMap.get(player.getUniqueId());
    }
    public static DollConfigManager getConfigManager(UUID uuid) {
        return dollConfigManagerMap.get(uuid);
    }
    public static DollConfigManager getConfigManager(String player) {
        return dollConfigManagerMap.get(Bukkit.getPlayer(player).getUniqueId());
    }
}
