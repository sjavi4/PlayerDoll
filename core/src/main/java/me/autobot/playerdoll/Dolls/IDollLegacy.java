...
public interface IDollLegacy {
     ...
     */
    static void setSkin(Player player, IDollLegacy iDoll) {
    ...
    static boolean executeHurt(IDollLegacy iDoll, Player doll, boolean damaged) {
        /*
        if (damaged) {
