...
import me.autobot.playerdoll.Command.Execute.echest;
import me.autobot.playerdoll.Command.Execute.exp;
import me.autobot.playerdoll.Command.Execute.inv;
...
public class Inventorymenu extends InvInitializer {
    ...
    public void decorate(Player player,Player doll) {
        ...
        actionMap.put(slot2,() -> {
            player.closeInventory();
            new inv(player,doll.getName(),null);
        ...
        actionMap.put(slot3, () -> {
            player.closeInventory();
            new echest(player,doll.getName(),null);
