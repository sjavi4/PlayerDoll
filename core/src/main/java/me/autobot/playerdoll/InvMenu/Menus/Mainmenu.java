...
import me.autobot.playerdoll.Command.Execute.set;
...
import me.autobot.playerdoll.Command.Execute.despawn;
import me.autobot.playerdoll.Command.Execute.remove;
...
public class Mainmenu extends InvInitializer {
    ...
    public void decorate(Player player,Player doll) {
        ...
        actionMap.put(slot2,()-> {
            player.closeInventory();
            new set(player,doll.getName(),null);
        ...
        actionMap.put(slot7,()->{
            ...
            player.closeInventory();
            new despawn(player, doll.getName(), null);
        });
        ...
        actionMap.put(slot8,()->{
            player.closeInventory();
            new remove(player, doll.getName(),null);
        });
