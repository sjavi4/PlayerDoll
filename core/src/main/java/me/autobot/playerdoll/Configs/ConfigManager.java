...
public final class ConfigManager {
    ...
    private static final String configVersion = "13";
    ...
    public ConfigManager(Plugin plugin) {
        ...
        if (!playerDirectory.exists()) YAMLManager.createFile(playerDirectory);
    ...
    public void countPlayerDoll() {
        ...
        for (File files : dollFiles) {
            ...
            YAMLManager yamlManager = YAMLManager.loadConfig(dollName,false);
            if (yamlManager == null) {
                continue;
            }
