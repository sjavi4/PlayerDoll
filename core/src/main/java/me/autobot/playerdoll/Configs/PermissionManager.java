...
public class PermissionManager {
    ...
    public Map<String, Boolean> flagGlobalDisplays = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    public Map<String, Boolean> flagGlobalToggles = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    public Map<String, Boolean> flagPersonalDisplays = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    public Map<String, Boolean> flagPersonalToggles = new TreeMap<>(String.CASE_INSENSITIVE_ORDER);
    ...
    public boolean canGiveDoll;
    public boolean canRenameDoll;
    ...
    private void loadPermission() {
        ...
        getPermission("canGiveDoll");
        getPermission("canRenameDoll");
    ...
    private void mirrorPermission() {
        ...
        this.canGiveDoll = mirror.canGiveDoll;
        this.canRenameDoll = mirror.canRenameDoll;
