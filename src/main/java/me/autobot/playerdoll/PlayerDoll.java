...
public final class PlayerDoll extends JavaPlugin {
    ...
    private static final String configVersion = "0.0.3";
    ...
    private boolean gameVersionCheck() {
        ...
        if (version.equalsIgnoreCase("v1_20_R1")) {
            System.out.println("Game Running in Version: 1.20.1");
        } else if (version.equalsIgnoreCase("v1_20_R2")) {
