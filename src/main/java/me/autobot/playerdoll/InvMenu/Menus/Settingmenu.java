...
public class Settingmenu extends InvInitializer {
    ...
    public void decorate(Player player,Player doll) {
        ...
        String desca = LangFormatter.YAMLReplace("controlButton.hinta",'&');
        String descb = LangFormatter.YAMLReplace("controlButton.hintb",'&');
 ...
 */
        ...
        ItemStack slot19 = ButtonSetter.setItem(Material.ENDER_EYE,null,getToggle((Boolean) toggleMap.get("setting.Ender Chest")) + langFile.getString("settingmenu.Ender Chest.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Ender Chest.desc",'&'),desca,descb));
        buttons.set(19,slot19);
        actionMap.put(slot19.getType(), (b)->configManager.setData("setting.Ender Chest",b));
        ...
        ItemStack slot21 = ButtonSetter.setItem(Material.TOTEM_OF_UNDYING,null,getToggle((Boolean) toggleMap.get("setting.Invulnerable")) + langFile.getString("settingmenu.Invulnerable.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Invulnerable.desc",'&'),desca,descb));
        buttons.set(21, slot21);
        actionMap.put(slot21.getType(),(b)-> configManager.setData("setting.Invulnerable",b));//doll.setNoDamageTicks(onoff?Integer.MAX_VALUE:0));

        ItemStack slot22 = ButtonSetter.setItem(Material.TARGET,null,getToggle((Boolean) toggleMap.get("setting.Hostility")) + langFile.getString("settingmenu.Hostility.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Hostility.desc",'&'),desca,descb));
        buttons.set(22, slot22);
        actionMap.put(slot22.getType(),(b)->configManager.setData("setting.Hostility",b));//serverPlayerDoll.enableHostility = onoff);

        ItemStack slot23 = ButtonSetter.setItem(Material.ARMOR_STAND,null,getToggle((Boolean) toggleMap.get("setting.Pushable")) + langFile.getString("settingmenu.Pushable.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Pushable.desc",'&'),desca,descb));
        buttons.set(23, slot23);
        actionMap.put(slot23.getType(),(b)->configManager.setData("setting.Pushable",b));//doll.setCollidable(onoff));

        ItemStack slot24 = ButtonSetter.setItem(Material.GRAVEL,null,getToggle((Boolean) toggleMap.get("setting.Gravity")) + langFile.getString("settingmenu.Gravity.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Gravity.desc",'&'),desca,descb));
        buttons.set(24, slot24);
        actionMap.put(slot24.getType(),(b)->configManager.setData("setting.Gravity",b));//{doll.setGravity(onoff);});

        ItemStack slot25 = ButtonSetter.setItem(Material.GLOW_INK_SAC,null,getToggle((Boolean) toggleMap.get("setting.Glow")) + langFile.getString("settingmenu.Glow.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Glow.desc",'&'),desca,descb));
        buttons.set(25, slot25);
        actionMap.put(slot25.getType(),(b)->configManager.setData("setting.Glow",b));//{doll.setGlowing(onoff);});

        ItemStack slot26 = ButtonSetter.setItem(Material.STONE_STAIRS,null,getToggle((Boolean) toggleMap.get("setting.Large Step Size")) + langFile.getString("settingmenu.Large Step Size.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Large Step Size.desc",'&'),desca,descb));
        buttons.set(26, slot26);
        actionMap.put(slot26.getType(),(b)->configManager.setData("setting.Large Step Size",b));//serverPlayerDoll.setMaxUpStep(onoff?1.0f:0.6f));

        ItemStack slot27 = ButtonSetter.setItem(Material.PHANTOM_MEMBRANE,null,getToggle((Boolean) toggleMap.get("setting.Phantom")) + langFile.getString("settingmenu.Phantom.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Phantom.desc",'&'),desca,descb));
        buttons.set(27, slot27);
        actionMap.put(slot27.getType(),(b)->configManager.setData("setting.Phantom",b));//{doll.setGravity(onoff);});

        /*
        ItemStack slot27 = ButtonSetter.setItem(Material.WOODEN_SWORD,null,getToggle((Boolean) toggleMap.get("setting.Attack")) + langFile.getString("settingmenu.Attack.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Attack.desc",'&'),desca,descb));
        buttons.set(27, slot27);
        actionMap.put(slot27,(b)->configManager.setData("setting.Attack",b));

        ItemStack slot28 = ButtonSetter.setItem(Material.STONE_BUTTON,null,getToggle((Boolean) toggleMap.get("setting.Use")) + langFile.getString("settingmenu.Use.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Use.desc",'&'),desca,descb));
        buttons.set(28, slot28);
        actionMap.put(slot28,(b)->configManager.setData("setting.Use",b));

        ItemStack slot29 = ButtonSetter.setItem(Material.PAPER,null,getToggle((Boolean) toggleMap.get("setting.Copy")) + langFile.getString("settingmenu.Copy.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Copy.desc",'&'),desca,descb));
        buttons.set(29, slot29);
        actionMap.put(slot29,(b)->configManager.setData("setting.Copy",b));

        ItemStack slot30 = ButtonSetter.setItem(Material.MINECART,null,getToggle((Boolean) toggleMap.get("setting.Dismount")) + langFile.getString("settingmenu.Dismount.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Dismount.desc",'&'),desca,descb));
        buttons.set(30, slot30);
        actionMap.put(slot30,(b)->configManager.setData("setting.Dismount",b));

        ItemStack slot31 = ButtonSetter.setItem(Material.ITEM_FRAME,null,getToggle((Boolean) toggleMap.get("setting.Mount")) + langFile.getString("settingmenu.Mount.name"),List.of(LangFormatter.YAMLReplace("settingmenu.Mount.desc",'&'),desca,descb));
        buttons.set(31, slot31);
        actionMap.put(slot31,(b)->configManager.setData("setting.Mount",b));
