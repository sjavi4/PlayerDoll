...
public class sprint implements SubCommandHandler {
    @Override
    public void perform(Player player, String dollName, String[] args) {
        ...
        if (_args[1] == null) {
            doll.getActionPack().setSprinting(!doll.isSprinting());
            return;
        }
        doll.getActionPack().setSprinting(_args[1].equalsIgnoreCase("true"));
    }
